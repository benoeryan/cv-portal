    ...
    <>
      ...
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 bg-[#F8F9FC] min-h-screen">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 tracking-tight uppercase">Dashboard Statistik v3.0</h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-8">
          <div
            ...
            className={`cursor-pointer card p-5 relative overflow-hidden transition-all duration-300 ${
              !filterStatus ? "bg-gradient-to-br from-[#2D1B69] to-[#4C2A9E] text-white shadow-xl scale-[1.02]" : "bg-white border-transparent hover:border-indigo-200 shadow-sm"
            }`}
          >
            ...
            return (
              <div
                ...
                className={`cursor-pointer card p-4 border-2 transition-all duration-200 flex flex-col justify-between ${
                  isActive ? `ring-2 ring-offset-1 ${config.border} border-current shadow-lg scale-[1.02]` : `bg-white ${config.border} hover:bg-gray-50 border-gray-100 shadow-sm`
                }`}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
           ...
           <div className="lg:col-span-2 flex flex-col gap-8">
              <div className="card p-5 border border-gray-100 shadow-sm bg-white flex-1">
                <div className="flex justify-between items-center mb-6">
                   <div className="flex items-center gap-2">
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  <button
                    ...
                    className="w-full py-3 bg-[#6366F1] text-white font-bold rounded-xl hover:bg-[#4F46E5] transition-all shadow-md shadow-indigo-200 uppercase text-xs tracking-widest"
                  >
                    ...
                    <tr key={c.id} className="hover:bg-indigo-50/30 transition-colors group">
                      ...
                      <td className="py-5 px-6">
                        <div className="flex justify-center items-center gap-2">
                          ...
                          >
                             <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                          </Link>
                        </div>
                      </td>
                    </tr>
